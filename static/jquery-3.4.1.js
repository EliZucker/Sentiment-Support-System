...
jQuery.extend( ***REMOVED***
	...
	***REMOVED***,
	...
	globalEval: function( code, options ) ***REMOVED***
		DOMEval( code, ***REMOVED*** nonce: options && options.nonce ***REMOVED*** );
	***REMOVED***,
		...
		if ( documentIsHTML ) ***REMOVED***
			...
			***REMOVED***
			...
			if ( support.qsa &&
				...
				if ( nodeType === 1 && rdescend.test( selector ) ) ***REMOVED***
...
jQuery.each( ***REMOVED***
	...
	***REMOVED***,
	contents: function( elem ) ***REMOVED***
		if ( typeof elem.contentDocument !== "undefined" ) ***REMOVED***
...
jQuery._evalUrl = function( url, options ) ***REMOVED***
